               ...
               <div className="registerform">
                  ...
                  <div className='fordis'>
                     ...
                     <div>
                        ...
                        <input type="text" placeholder='Select State' /><br />
                     </div>
                  </div>
                  ...
                  <div className='fordis'>
                     ...
                     <div>
                        ...
                        <input type={showpasward ? "text" : "password"} placeholder='Enter Password' /><br />
                  ...
                  <div className='privacypolicy'><input type="checkbox" name="" id="" /> I agree to Apnawakeel.pk Privacy Policy & Terms.</div>
