...
<input type={showpasward ? "text" : "password"} placeholder='Enter Pasward' /><br />

<svg onClick={show} xmlns="http://www.w3.org/2000/svg" width="20" height="15" viewBox="0 0 28 19" fill="none">
